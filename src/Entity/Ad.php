...
class Ad
{
     ...
     * @Assert\Length(
     *      min=10,
     *      minMessage= "l'introduction doit être supérieur à 10 caractères minimum"
     * )
     */
    ...
    /**
     * Permet d'obtenir un tableau des jours indisponibles
     *
     * @return array Un tableau d'objet de DateTime
     */
